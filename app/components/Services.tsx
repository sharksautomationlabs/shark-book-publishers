    ...
    <div className="w-full bg-white flex justify-center">
      ...
      <div className="relative w-full max-w-[1920px] h-auto py-16 lg:aspect-[1920/1080] lg:py-0 overflow-hidden select-none">
        ...
        <div className="relative z-20 w-full h-full flex flex-col items-center justify-center text-white pt-8 sm:pt-10 md:pt-12 lg:pt-20 px-4 sm:px-5 lg:px-0">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-[94px] font-semibold" style={{ fontFamily: "'Barlow Condensed', sans-serif", ...textShadow }}>
            Services
          </h1>
          
          {/* Services Grid */}
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-x-6 w-full max-w-[1400px] mt-6 sm:mt-7 md:mt-8 lg:mt-16 mx-4 sm:mx-5 lg:mx-20">
            {servicesData.map((service, index) => (
              // CARD SIZE INCREASED
              <div key={index} className="bg-white/10 backdrop-blur-lg rounded-xl sm:rounded-2xl lg:rounded-3xl px-3 sm:px-4 lg:px-6 py-3 sm:py-4 lg:py-5 border-2 border-white h-[260px] sm:h-[280px] md:h-[300px] lg:h-[380px] flex flex-col items-center text-center overflow-hidden service-card-flash group transition-none">
                <h2 className="text-sm sm:text-base md:text-lg lg:text-[28px] font-semibold" style={{ fontFamily: "'Barlow Condensed', sans-serif" }}>
                  {service.title}
                </h2>
                <p className="mt-1 sm:mt-2 text-xs sm:text-sm lg:text-[16px] leading-4 sm:leading-5 lg:leading-[24px] max-w-[140px] sm:max-w-[180px] md:max-w-[200px] lg:max-w-[250px]" style={{ fontFamily: "'Barlow', sans-serif" }}>
                  {service.description}
                </p>
                {/* Service Image */}
                <div className="relative mt-auto w-full h-[180px] sm:h-[200px] md:h-[220px] lg:h-[260px] flex items-center justify-center">
                  <div className={`relative w-full h-full transition-transform duration-300 ease-in-out group-hover:scale-90 ${index === 3 ? 'translate-y-6 sm:translate-y-8 md:translate-y-10 lg:translate-y-12' : 'translate-y-4 sm:translate-y-5 md:translate-y-6 lg:translate-y-8'}`}>
           ...
           {/* CTA Buttons */}
           <div className="flex flex-col lg:flex-row items-center justify-center gap-4 lg:gap-8 mt-8 lg:mt-16 w-full">
            <Link 
              href="/books"
              className="group flex items-center justify-center lg:justify-between w-full lg:w-[220px] h-[52px] bg-[#35c4dd] text-[#063f4a] font-bold rounded-full text-xl shadow-lg overflow-hidden relative p-2"
            >
                <span className="relative z-10 lg:pl-3 whitespace-nowrap" style={{ fontFamily: "'Barlow', sans-serif" }}>Order Your Book</span>

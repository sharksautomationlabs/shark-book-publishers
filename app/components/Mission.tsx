...
export default function MissionSection({ 
  ...
  const contentData = {
    mission: {
      title: 'Our Mission',
      description: 'We are dedicated to discovering exceptional talent and delivering world-class publishing experiences for readers and authors alike. Our mission is to make great stories accessible to everyone, everywhere.',
      badge: 'About Us'
    },
    values: {
      title: 'Our Values',
      items: [
        {
          title: 'Integrity',
          description: 'We believe in transparency and honesty. No hidden fees, no confusing contracts.'
        },
        {
          title: 'Empowerment',
          description: 'You are the author. You retain 100% of your rights and royalties. We are here to support your vision, not control it.'
        },
        {
          title: 'Excellence',
          description: 'We are committed to providing world-class quality in every book we touch.'
        }
      ],
      badge: 'About Us'
    },
    vision: {
      title: 'Our Vision',
      description: 'Our vision is to be a global leader in publishing excellence, setting new standards for quality, creativity, and accessibility in the world of storytelling',
        ...
        <div className={`relative z-10 w-full px-5 lg:px-20 ${useCustomContent ? 'h-full flex items-center' : 'h-full'}`}>
          ...
          <div className={`relative w-full ${useCustomContent ? 'h-full' : 'h-auto lg:h-auto lg:min-h-[800px]'}`}>
                ...
                {useCustomContent ? (
                  ...
                  <AnimatePresence mode="wait">
                    ...
                    >
                      ...
                      {activeTab === 'values' && 'items' in currentContent ? (
              ...
              <div className={`${useCustomContent ? 'relative lg:absolute right-0 lg:right-[-5%] top-0 w-full lg:w-[60%] h-[400px] lg:h-[100%] z-10 mt-2 lg:mt-0' : 'relative lg:absolute right-0 lg:right-[-10%] top-0 lg:top-[-10%] w-full lg:w-[65%] h-[400px] lg:h-[120%] z-10 mt-2 lg:mt-0'}`}>
                ...
                >
                  <div className="absolute w-[80%] h-[40%] top-[15%] left-[10%] z-0 animate-shark-lean">
                  ...
                  <div className="absolute inset-0 z-10 flex items-center justify-center">
                      <div className="relative w-[80%] h-[80%]">
                        <Image 
                          ...
                          alt="Business woman" 
                          fill
                          className="object-contain filter grayscale transform -scale-x-100" 
                        />
                      </div>
                  </div>
                  <div className="absolute w-[35%] h-auto bottom-[15%] right-[5%] z-20" style={{ animation: 'float 3s ease-in-out infinite' }}>
                      <Image 
                        src={logoType === 'walmart' ? imgWalmartLogo : logoType === 'amazon' ? imgAmazonLogo : logoType === 'tiktok' ? imgTikTokLogo : imgLuna} 
                        alt={logoType === 'walmart' ? "Walmart Logo" : logoType === 'amazon' ? "Amazon Logo" : logoType === 'tiktok' ? "TikTok Logo" : "Luna"} 
                        width={180} 
                        height={180} 
                        objectFit="contain" 
                      />

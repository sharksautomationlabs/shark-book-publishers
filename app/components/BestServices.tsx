    ...
    <div ref={ref} className="relative w-full bg-white pt-16 lg:pt-32 xl:pt-48">
      ...
      <div className="relative z-20 container mx-auto px-5 lg:px-20 pb-16 lg:pb-24 text-white">
        ...
        >
          <GetQuoteButton />
          <button 
            className="flex items-center justify-center lg:justify-between gap-3 w-full lg:w-[170px] h-[56px] bg-white rounded-full border-2 border-[#35c4dd] p-2 shadow-lg"
            onClick={() => {
